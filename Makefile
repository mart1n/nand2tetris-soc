...
SOURCES := ${current_dir}/top.sv \
		   ${current_dir}/HackCPU.sv \
		   ${current_dir}/HackALU.sv \
		   ${current_dir}/DualPortScreen.sv \
		   ${current_dir}/VgaSyncGen.sv \
		   ${current_dir}/Ps2Receiver.sv \
		   ${current_dir}/HackKeyMapper.sv
